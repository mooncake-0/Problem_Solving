...
<br/><br/>
# 4. 알고리즘 복습을 위한 Set (필요하다 생각할 때마다 추가)
1. 정렬
> 각각 이론은 그래도 복습

2. BFS / DFS (기본 문제만 좀 복습하는 수준)
> 1937 좋음 (꼭 칸으로 이동만 DFS 가 아니라, 재귀가 DFS이다)
> BFS 가 visited 이 왜 동작하는지 이해해야 한다 (역으로 지나온 길 트랙킹 하는 문제도 풀어보면 좋을 듯)

3. 이진 탐색
> https://www.acmicpc.net/blog/view/109 이거 읽어야 한다
> 

4. Segment Tree

5. Heap (PQ) - 둘의 차이는 스레드 관련
